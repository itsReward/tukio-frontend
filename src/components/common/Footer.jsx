    ...
    const sections = [
        {
            title: 'Events',
            links: [
                { name: 'Browse Events', to: '/events' },
                { name: 'Create Event', to: '/events/create' },
                { name: 'Categories', to: '/events/categories' },
                { name: 'Calendar', to: '/events/calendar' },
            ],
        },
        {
            title: 'Venues',
            links: [
                ...
                { name: 'Venue Map', to: '/venues/map' },
                { name: 'Request Venue', to: '/venues/request' },
            ],
        },
        {
            title: 'Community',
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        ...
                        <p className="text-neutral-400 mb-4">
                            Your centralized platform for campus events, venue allocation, and community engagement.
                        </p>
                ...
                <div className="border-t border-neutral-800 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center">
                    <div className="text-neutral-400 text-sm mb-4 md:mb-0">
                        &copy; {currentYear} Tukio. All rights reserved.
                    </div>
                    <div className="flex space-x-6">
                        ...
                        <Link to="/accessibility" className="text-neutral-400 hover:text-white text-sm">
                            Accessibility
                        </Link>
                    </div>
                </div>
